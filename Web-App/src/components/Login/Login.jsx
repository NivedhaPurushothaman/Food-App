        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
            <div style={{ boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.3)', padding: '20px', borderRadius: '8px', maxWidth: '300px', margin: 'auto' }}>
                <form action="">
                    ...
                    <input type="submit" style={{ width: '100%', padding: '8px', boxSizing: 'border-box', backgroundColor: 'blue', color: 'white', borderRadius: '4px', cursor: 'pointer' }} value="Submit" onClick={onSubmit} />
                </form>
            </div>
        </div>
    )
